...
# url = f"{base_url}?base={from_code}&symbols={to_code}"
...
#     exchange_rate = data["rates"][to_code]

#     # Print the exchange rate
#     print(f"Exchange rate from {from_code} to {to_code}: {exchange_rate}")
# else:
#     # Print an error message if the request was not successful
#     print("Error retrieving exchange rate:", response.text)
